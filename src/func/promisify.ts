...
import type { AsyncFunction } from "../types/function/asyncFunction";
...
export function promisify<PromisedFunc extends (...args: any[]) => any = AsyncFunction>(
    fn: (...args: any) => any,
    options?: PromiseifyOptions<PromisedFunc>,
) {
    const { buildArgs, parseCallback } = Object.assign(
        ...
        options,
    ) as Required<PromiseifyOptions<PromisedFunc>>;
